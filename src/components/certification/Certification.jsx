    ...
    return (
        ...
        <div className='centeredSection' id='certification'>
            ...
            <div className='cert_row'>
                ...
                <div className='cert_col'>
                    <img src='/assets/images/Tutedude.com_Mern_Stack_certificate.jpg' alt='internship' />
                    <h5 className='cert_head'>MERN STACK WEB DEVELOPMENT</h5>
                    <p className='cert_dt'>Jan 2024 - Mar 2024</p>
                </div>
                <div className='cert_col'>
                    <img src='/assets/images/QSpider_SW_Testing.jpg' alt='internship' />
                    <h5 className='cert_head'>SOFTWARE TESTING</h5>
                    <p className='cert_dt'>Jun 2019 - Nov 2019</p>
                </div>
                <div className='cert_col'>
                    <img src='/assets/images/Lakshya_Oracle.png' alt='internship' />
